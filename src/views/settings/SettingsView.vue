  ...
  <div>
    <div class="flex items-center justify-between mb-6">
      <div>
        ...
        <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">System configuration and settings.</p>
      </div>
      <button
    ...
    <div class="bg-white dark:bg-gray-800/20 rounded-2xl border border-gray-100 dark:border-gray-700/50 p-6">
      <div class="flex flex-col items-center justify-center py-16 text-center">
        ...
        <p class="text-sm font-semibold text-gray-600 dark:text-gray-300">System Settings</p>
