...
const subtitle = computed(() => t('settings.subtitle'))
const buttonText = computed(() => t('settings.button.save_changes'))
</script>
...
<template>
  <div>
    ...
    <div
      class="bg-white dark:bg-gray-800/20 rounded-2xl border border-gray-100 dark:border-gray-700/50 p-6"
    >
