  ...
  <div class="space-y-6">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
      <div
        ...
        :key="role.id"
        class="bg-white dark:bg-gray-800/20 border border-gray-100 dark:border-gray-700/50 rounded-2xl overflow-hidden transition-all duration-200 hover:shadow-sm"
      >
        <div class="px-6 py-5 border-b border-gray-100 dark:border-gray-700/50">
          ...
          <div class="flex items-center gap-3 mt-4">
            <span
              class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-gray-100 dark:bg-gray-700 text-xs font-medium text-gray-600 dark:text-gray-300"
            >
              <svg
                class="w-3.5 h-3.5"
                viewBox="0 0 24 24"
            ...
            <span
              class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-blue-50 dark:bg-blue-500/10 text-xs font-medium text-blue-700 dark:text-blue-400 border border-blue-100 dark:border-blue-500/20"
            >
              <svg
                class="w-3.5 h-3.5"
                viewBox="0 0 24 24"
        ...
        <div
          class="px-6 py-3 border-t border-gray-100 dark:border-gray-700/50 bg-gray-50/50 dark:bg-gray-800/30"
        >
          <p class="text-xs text-gray-400">
            {{ rolesFooterCreated }} {{ formatDate(role.createdAt) }}
          </p>
        </div>
      </div>
    </div>
    ...
    <div v-if="filteredRoles.length === 0" class="flex flex-col items-center justify-center py-16">
      <div
        class="w-14 h-14 rounded-2xl bg-gray-100 dark:bg-gray-800 flex items-center justify-center mb-3"
      >
        <svg
