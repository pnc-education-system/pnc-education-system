      ...
      <form class="space-y-5" @submit.prevent="handleLogin">
        ...
        <div>
          ...
          >
            ...
            <input
              ...
              :class="
                emailError
                  ? 'text-red-900 dark:text-red-300 placeholder-red-400 dark:placeholder-red-500'
                  : ''
              "
        ...
        <div>
          ...
          <div class="mt-1.5 flex items-center justify-between">
            ...
            <router-link
              to="/forgot-password"
              class="text-sm font-medium text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300 transition-colors ml-auto"
              >{{ loginForgotPassword }}</router-link
            >
          </div>
        </div>
        ...
        <div
          class="flex items-start gap-2.5 rounded-xl bg-blue-50 dark:bg-blue-500/10 px-4 py-3.5 border border-blue-100 dark:border-blue-500/20"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
