...
<template>
  <div>
    <h3 class="text-sm font-bold text-gray-800 mb-3">Upload School Logo</h3>
    <div
    ...
    >
      ...
      <div v-if="modelValue" class="relative inline-block">
        <img
          :src="modelValue"
          alt="School Logo"
          class="w-16 h-16 rounded-lg object-contain border-2 border-white shadow-lg bg-white p-1"
        />
        <button
      ...
      <div v-else class="space-y-1">
        ...
        <div>
          <p class="text-xs font-medium text-gray-700">Click or drag logo</p>
